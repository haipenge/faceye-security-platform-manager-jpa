...
<div class="panel panel-primary">
	<div class="panel-heading">
		<div class="panel-title">
			<fmt:message key="platform.security.resource.detail"></fmt:message>
		</div>
	</div>
	<div class="panel-body">
			<fieldset>
					...
					<label class="col-md-4 control-label" for="resource">
					  <fmt:message key="platform.security.resource.name"></fmt:message>
					 </label>
					<div class="col-md-4">
						${resource.name}
					</div>
								...
								<div class="form-group">
					<label class="col-md-4 control-label" for="resource">
					  <fmt:message key="platform.security.resource.url"></fmt:message>
					 </label>
					<div class="col-md-4">
						${resource.url}
					</div>
								...
								<div class="form-group">
					<label class="col-md-4 control-label" for="resource">
					  <fmt:message key="platform.security.resource.roles"></fmt:message>
					 </label>
					<div class="col-md-4">
						${resource.roles}
					</div>
