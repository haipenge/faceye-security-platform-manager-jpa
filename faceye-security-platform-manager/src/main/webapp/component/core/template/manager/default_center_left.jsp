			...
			<div class="content">
				...
				<ul class="cl-vnavigation">
					...
					<li><a href="#"><i class="fa fa-home"></i><span><fmt:message key="global.manager"></fmt:message></span></a>
						<ul class="sub-menu">
							<li class="<%=JspUtil.isActive(request, "user")%>"><a href="<c:url value="/platform/security/user/home"/>"><fmt:message
										key="platform.security.user.manager"></fmt:message></a></li>
							<li class="<%=JspUtil.isActive(request, "role")%>"><a href="<c:url value="/platform/security/role/home"/>"><fmt:message
										key="platform.security.role.manager"></fmt:message></a></li>
							<li class="<%=JspUtil.isActive(request, "resource")%>"><a href="<c:url value="/platform/security/resource/home"/>"><fmt:message
										key="platform.security.resource.manager"></fmt:message></a></li>
							
							<li class="<%=JspUtil.isActive(request, "menu")%>"><a href="/platform/security/menu/home"><fmt:message
										key="platform.security.menu.manager"></fmt:message></a></li>
